...
.rfm-child {
  transform: var(--transform);
}`);const a=e.forwardRef(function({style:n={},className:o="",autoFill:l=!1,play:m=!0,pauseOnHover:d=!1,pauseOnClick:f=!1,direction:s="left",speed:v=50,delay:C=0,loop:h=0,gradient:p=!1,gradientColor:x="white",gradientWidth:w=200,onFinish:b,onCycleComplete:g,onMount:q,children:R},O){const[$,Q]=e.useState(0),[k,Y]=e.useState(0),[z,B]=e.useState(1),[D,F]=e.useState(!1),H=e.useRef(null),E=O||H,P=e.useRef(null),j=e.useCallback(()=>{if(P.current&&E.current){const y=E.current.getBoundingClientRect(),T=P.current.getBoundingClientRect();let M=y.width,N=T.width;(s==="up"||s==="down")&&(M=y.height,N=T.height),B(l&&M&&N&&N<M?Math.ceil(M/N):1),Q(M),Y(N)}},[l,E,s]);e.useEffect(()=>{if(D&&(j(),P.current&&E.current)){const y=new ResizeObserver(()=>j());return y.observe(E.current),y.observe(P.current),()=>{y&&y.disconnect()}}},[j,E,D]),e.useEffect(()=>{j()},[j,R]),e.useEffect(()=>{F(!0)},[]),e.useEffect(()=>{typeof q=="function"&&q()},[]);const U=e.useMemo(()=>l?k*z/v:k<$?$/v:k/v,[l,$,k,z,v]),ee=e.useMemo(()=>Object.assign(Object.assign({},n),{"--pause-on-hover":!m||d?"paused":"running","--pause-on-click":!m||d&&!f||f?"paused":"running","--width":s==="up"||s==="down"?"100vh":"100%","--transform":s==="up"?"rotate(-90deg)":s==="down"?"rotate(90deg)":"none"}),[n,m,d,f,s]),te=e.useMemo(()=>({"--gradient-color":x,"--gradient-width":typeof w=="number"?`${w}px`:w}),[x,w]),X=e.useMemo(()=>({"--play":m?"running":"paused","--direction":s==="left"?"normal":"reverse","--duration":`${U}s`,"--delay":`${C}s`,"--iteration-count":h?`${h}`:"infinite","--min-width":l?"auto":"100%"}),[m,s,U,C,h,l]),L=e.useMemo(()=>({"--transform":s==="up"?"rotate(90deg)":s==="down"?"rotate(-90deg)":"none"}),[s]),V=e.useCallback(y=>[...Array(Number.isFinite(y)&&y>=0?y:0)].map((T,M)=>i.default.createElement(e.Fragment,{key:M},e.Children.map(R,N=>i.default.createElement("div",{style:L,className:"rfm-child"},N)))),[L,R]);return D?i.default.createElement("div",{ref:E,style:ee,className:"rfm-marquee-container "+o},p&&i.default.createElement("div",{style:te,className:"rfm-overlay"}),i.default.createElement("div",{className:"rfm-marquee",style:X,onAnimationIteration:g,onAnimationEnd:b},i.default.createElement("div",{className:"rfm-initial-child-container",ref:P},e.Children.map(R,y=>i.default.createElement("div",{style:L,className:"rfm-child"},y))),V(z-1)),i.default.createElement("div",{className:"rfm-marquee",style:X},V(z))):null});return A.default=a,A}var ve=me();const K=se(ve);function Re(t){const{children:e,className:c,wrapperClassName:i,onClick:a,autoPlay:r=!1}=t,n=u.useRef(null),[o,l]=u.useState(!1),[m,d]=u.useState(!1),f=u.useCallback(()=>{if(n.current){const{scrollWidth:s,clientWidth:v}=n.current;l(s>v)}},[]);return u.useLayoutEffect(()=>(f(),window.addEventListener("resize",f),()=>{window.removeEventListener("resize",f)}),[f]),S.jsx("div",{onClick:a,role:a?"button":void 0,className:I("h-min w-auto overflow-hidden",i),onMouseEnter:()=>d(!0),onMouseLeave:()=>d(!1),children:o?S.jsx(K,{play:m||r,className:"[&_.rfm-child]:mr-3 [&_.rfm-child]:leading-tight",children:e}):S.jsx("p",{ref:n,className:I("overflow-hidden leading-tight whitespace-nowrap",c),children:e})})}function Ee(t){const{children:e,className:c,wrapperClassName:i,onClick:a,autoPlay:r=!1}=t,n=u.useRef(null),[o,l]=u.useState(!1),[m,d]=u.useState(!1),f=u.useCallback(()=>{if(n.current){const{scrollWidth:s,clientWidth:v}=n.current;console.log(s>v,s,v),l(s>v)}},[]);return u.useLayoutEffect(()=>{console.log("checking on layout effect"),f()},[f,e]),S.jsxs("div",{onClick:a,role:a?"button":void 0,className:I("relative h-min w-auto overflow-hidden",i),onMouseEnter:()=>d(!0),onMouseLeave:()=>d(!1),children:[S.jsx("p",{ref:n,className:I("absolute top-0 w-full overflow-hidden leading-tight whitespace-nowrap",o&&"opacity-0",c),children:e}),S.jsx(K,{play:m||r,className:I("[&_.rfm-child]:mr-3 [&_.rfm-child]:leading-tight",!o&&"pointer-events-none opacity-0"),children:e})]})}export{Ee as B,ye as P,Re as S,ge as a,we as b,ce as c,Se as d,be as e,xe as f,J as g,Ce as u};
