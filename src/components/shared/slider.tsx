  ...
  return (
    <SliderPrimitive.Root
      ...
      <SliderPrimitive.Track
        ...
        className={cn(
          'relative grow overflow-hidden rounded-full border-2 bg-bg group-hover:rounded-none data-[orientation=horizontal]:h-5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5'
        )}>
